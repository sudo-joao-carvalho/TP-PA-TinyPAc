...
public class Clyde extends Element implements Serializable {
    ...
    public Clyde(GameData gameData) {
        ...
        possibleDirections.add(new Clyde.Direction(0, -1)); // Cima
        possibleDirections.add(new Clyde.Direction(0, 1));  // Baixo
        possibleDirections.add(new Clyde.Direction(-1, 0)); // Esquerda
        possibleDirections.add(new Clyde.Direction(1, 0));  // Direita
    ...
    public void evolve(KeyCode key) {
        ...
        if (insideCave) {
            ...
            if (!isValidPosition(myPos.y() + dy, myPos.x() + dx)) {
                ...
                Clyde.Direction validDirection = null;

                for (Clyde.Direction dir : possibleDirections) {
                ...
                if (directionsCount == 1 && validDirection != null) {
                    ...
                    List<Clyde.Direction> availableDirections = new ArrayList<>();
                    ...
                    if (!availableDirections.isEmpty()) {
                        ...
                        Clyde.Direction newDirection = availableDirections.get(0);
                        dx = newDirection.dx;
                        dy = newDirection.dy;
